...
<div class="padding">
  <div class="container">
    <div class="row">
       ...
       <div class="col-sm-6 text-center">
         <h2>About ATES Notes</h2>
         <p class="lead">ATES Notes is a idea to store necessary class notes and also Question paper by Class wise.
         ...
         <p class="lead">The Online Platform provide for ATES Student to grow yourself and save time to find out the
 ...
 <footer class="container-fluid text-center">
  <div class="row">
    ...
    <div class="col-sm-4">
      <h3>Connect Me.</h3>
      <a href="https://www.facebook.com/ravindra.shelke.3323/"><i class="fab fa-facebook-f"></i></a>
	  <a href="https://www.instagram.com/ravi_shelke98/?hl=en"><i class="fab fa-instagram"></i></a>
	  <a href="mailto:shelkeravindra002@gmail.com"><i class="fa fa-envelope" aria-hidden="true"></i></a>
